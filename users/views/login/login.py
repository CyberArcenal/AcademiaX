...
from common.enums.users import AccountStatus
...
from users.serializers.user.display import UserDisplaySerializer
...
class LoginView(APIView):
    ...
    def _complete_login(self, user, request, client_ip, user_agent, device_name):
        try:
            ...
            user_data = UserDisplaySerializer(user, context={"request": request}).data
